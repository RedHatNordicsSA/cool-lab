...
reboot
text
network --bootproto=dhcp --device=link --activate --onboot=on --hostname=apu.localnet
...
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHV4O/qEctm+YmAY/o0aKk+sgxbFhLMsNN1m4j8FNKSF admin@coollab
__AUTHKEYS__
